public class SeniorCitizen extends Individual{

	public SeniorCitizen(){	
	}
	public SeniorCitizen(float taxSlab1,float taxSlab2,float taxSlab3,int slabs[]){
	...
	public void calcTax(float salary,int age)
	{
		...
		System.out.println("I AM FROM SENIOR TAX CALCULATOR CLASS");
		System.out.println("TAX TO BE PAID: "+tax);
	}
	public void show(){
		System.out.println("I AM FROM SENIOR CITIZEN TAX CALCUALTOR");
	}
	public void message(){
			System.out.println("NO METHOD AVAILABLE IN SUPER CLASS");
	}
}
